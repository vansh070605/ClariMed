...
def validate_measurements(measurements: List[Dict[str, Any]]) -> Tuple[List[Dict[str, Any]], List[Dict[str, Any]]]:
    """
    ...
    logger.info(f"Validated {len(accepted)} measurements. Dropped {len(dropped)} invalid measurements.")
